...
export type MetadataFetchState = 'started' | 'succeeded' | 'failed' | 'cancelled';

export type MetadataFetchLifecycleEvent = {
  requestId: string;
  url: string;
  logPath: string;
...
export type FetchHistoryStatus = 'fetched' | 'fetch_failed';
