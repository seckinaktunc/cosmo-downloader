...
const FirefoxIcon: FC<{ size: number }> = ({ size }) => (
        <svg
        ...
        >
            <defs>
                ...
                >
                    ...
                    <stop offset=".351" stopColor="#b11927" stopOpacity="0.74" />
                    <stop offset=".435" stopColor="#db293d" stopOpacity="0.343" />
                    <stop offset=".497" stopColor="#f5334b" stopOpacity="0.094" />
                ...
                >
                    ...
                    <stop offset=".278" stopColor="#8c4ff3" stopOpacity="0.064" />
                    <stop offset=".747" stopColor="#7716a8" stopOpacity="0.45" />
                    <stop offset=".975" stopColor="#6e008b" stopOpacity="0.6" />
                </radialGradient>
                <radialGradient
                    id="SVGYeK40d5n"
                    cx="-7937.731"
                ...
                <linearGradient
                    ...
                    gradientUnits="userSpaceOnUse"
                >
                    <stop offset=".167" stopColor="#fff44f" stopOpacity="0.8" />
                    <stop offset=".266" stopColor="#fff44f" stopOpacity="0.634" />
                    <stop offset=".489" stopColor="#fff44f" stopOpacity="0.217" />
